  ...
  <div class="tree-node">
    ...
    >
      ...
      <button
        v-if="hasChildren"
        @click.stop="toggle"
        class="flex h-5 w-5 flex-shrink-0 items-center justify-center text-gray-500 hover:text-gray-700"
      >
      ...
      <!-- Entity icon -->
      <span class="flex-shrink-0 text-xl">{{ entityIcon }}</span>

      <!-- Label with search highlight -->
      <span class="flex-1 font-medium" v-html="highlightedLabel"></span>
